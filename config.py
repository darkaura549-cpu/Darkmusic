...
class Config:
    def __init__(self):
        ...
        # Support Links
        self.SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/fuckerbihari00")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/fuckerbihario")
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://i.ibb.co/C3gxD5TD/file-0000000002607208a8a583eeac1343e9.png")
        self.PING_IMG: str = getenv("PING_IMG", "https://i.ibb.co/bMR7PMcx/file-00000000990c72088b20990f2571a633.png")
        self.START_IMG: str = getenv("START_IMG", "https://i.ibb.co/RTfXMBsM/file-00000000a69c7208b84b5236c4746290.png")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://i.ibb.co/C3gxD5TD/file-0000000002607208a8a583eeac1343e9.png")
